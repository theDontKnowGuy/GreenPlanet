...
const char* ssid =    "Taranis-guest";
const char* password = "wehelpfarmersgrow";
...
String logTarget =     "channels/1023335/bulk_update.csvchannels/1023335/bulk_update.csv"; /// leave empty if no local logging server (will only Serial.print logs)
